...
class Student(models.Model):
    ...
    creator = models.ForeignKey(CustomUser, related_name='students', on_delete=models.SET_NULL, null=True)
...
class StudentSponsor(models.Model):
    ...
    creeator = models.ForeignKey(CustomUser, related_name='collect_moneys', on_delete=models.SET_NULL, null=True)
